...
interface MycarCategoryDetailBoxRowData {
  label: string;
  type: string;
}
const formFields: MycarCategoryDetailBoxRowData[] = [
  { label: "카테고리 메뉴명", type: "text" },
  { label: "해당 메뉴 노출", type: "radio" },
  { label: "하위 분류 노출", type: "radio" },
];

const MycarCategoryDetailBox = () => {
...
const SavedButton = styled.button`
  ...
  line-height: 2rem;
`;
export default MycarCategoryDetailBox;
