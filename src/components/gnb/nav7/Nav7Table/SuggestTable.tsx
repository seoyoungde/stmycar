...
import SuggestPopup from "../../../Popup/Nav7/SuggestPopup";
import SuggestPopup2 from "../../../Popup/Nav7/SuggestPopup2";
import SuggestPopup3 from "../../../Popup/Nav7/SuggestPopup3";
  ...
  return (
    <PageContainer>
      <Container>
        ...
        />
        {isPopupVisible && <SuggestPopup onClose={closePopup} />}
        {isPopup2Visible && <SuggestPopup2 onClose={closePopup2} />}
        {isPopup3Visible && <SuggestPopup3 onClose={closePopup3} />}
      </Container>
      <ChangeSection>
        <ChangeBox>
          <ChangeTitle>상태변경</ChangeTitle>
          <select
            style={{ width: "7rem", height: "1.4375rem", margin: "auto" }}
          >
