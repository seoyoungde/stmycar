...
interface NoticeManagePopup3Props {
  onClose: () => void;
}
...
const NoticeManagePopup3: React.FC<NoticeManagePopup3Props> = ({ onClose }) => {
                ...
                <InputCell>
                  ...
                  {field.label === "분류항목" && (
                    <RadioBox>
                      ...
                      >
                        <option value="1">분류 항목 선택</option>
                        <option value="2">서비스관련</option>
                        <option value="3">이벤트(당첨)</option>
                        <option value="4">시스템점검</option>
                        <option value="5">약관업데이트</option>
                      </select>
                    </RadioBox>
                  )}
...
`;
export default NoticeManagePopup3;
