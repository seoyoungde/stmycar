...
const OnebyonePopup4: React.FC<OnebyonePopup4Props> = ({ onClose }) => {
            ...
            {formFields2.map((field, index) => (
              <BoxRow key={index} isEven={index % 2 === 0}>
                ...
                <InputCell width="20.625rem">
                  {field.label === "제목" && <div>ㄴㅇㄹㄴㅇㄹ</div>}
                  {field.label === "담당자" && (
                    <div>고객지원팀 홍길순 주임</div>
                  )}
                  {field.label === "회신내용" && (
                    <div>
                      ㄴㅇㄹ ㄴㅇㄹ <br />
