...
interface NoticeManagePopupProps {
  onClose: () => void;
}
const formFields = [
  { label: "제목", type: "text" },
...
const NoticeManagePopup: React.FC<NoticeManagePopupProps> = ({ onClose }) => {
  return (
...
`;
export default NoticeManagePopup;
