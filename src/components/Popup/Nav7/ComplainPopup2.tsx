...
const ComplainPopup2: React.FC<ComplainPopupProps> = ({ onClose }) => {
  ...
  return (
    <Overlay onClick={onClose}>
      <PopupContainer onClick={(e) => e.stopPropagation()}>
        ...
        <PageTitle>* 회원 신고 등록 내용</PageTitle>
        <Section>
          <Box>
            {formFields.map((field, index) => (
              <BoxRow key={index} isEven={index % 2 === 0}>
                ...
                <InputCell>
                  ...
                  {field.label === "항목분류" && (
                    <TextBox>서비스 불친절 문의</TextBox>
                  )}
                  {field.label === "제목" && <TextBox>ㄴㅇㄹㄴㅇㄹ</TextBox>}
                  {field.label === "문의 내용" && (
        ...
        <PageTitle>* 신고 대상회원(매장) 소명/이의제기 등록 내용</PageTitle>
        <Section>
          <Box>
            {formFields2.map((field, index) => (
              <BoxRow key={index} isEven={index % 2 === 0}>
                ...
                <InputCell width="20.625rem">
                  ...
                  {field.label === "제목" && <TextBox>ㅇㅁㅇㄹㅁㄹㅁ</TextBox>}
                  {field.label === "소명/이의제기내용" && (
                    <TextBox>ㅁㄹㅁㅇㄹㅁㄹ</TextBox>
                  )}
                  {field.label === "첨부자료" && (
                    <TextBox>
                      <ColorText>123.jpg</ColorText>
        ...
        <PageTitle>* 플랫폼 운영 담당자 확인 및 처리 사항</PageTitle>
        <Section>
          <Box>
            {formFields3.map((field, index) => (
              <BoxRow key={index} isEven={index % 2 === 0}>
                <LabelCell>{field.label}</LabelCell>
                <InputCell width="20.625rem">
                  {field.label === "제목" && <TextBox>ㄴㅇㅇㅁㅇㅁㅁ</TextBox>}
                  {field.label === "담당자" && (
                  ...
                  {field.label === "사실확인 및  처리결과 내용" && (
                    <TextBox>
                      ㅁㄹㅁㅇㄹㅁㄹㅁ <br />
                      자세한 안내 더보기:<ColorText> ADAFA</ColorText>
                    </TextBox>
                  )}
                  {field.label === "첨부자료" && <TextBox>123.jpg</TextBox>}
                </InputCell>
              </BoxRow>
            ))}
          </Box>
