...
interface SaleCouponManagePopup2Props {
  onClose: () => void;
}

const SaleCouponManagePopup2: React.FC<SaleCouponManagePopup2Props> = ({
  onClose,
}) => {
...
`;
export default SaleCouponManagePopup2;
